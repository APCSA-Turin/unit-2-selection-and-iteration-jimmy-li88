public class ArrayManipulator {
  ...
  public double getNumsAverage(){
    double firstNum = nums[0]; 
    double middleNum = nums[nums.length / 2 ];
    double lastNum = nums[nums.length - 1]; 
    double total = firstNum + middleNum + lastNum; 
    return total / 3;  
  }
