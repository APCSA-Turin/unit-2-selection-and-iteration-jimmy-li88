...
public class Main {
     public static void main(String[] args) {
          ...
          Rectangle1 myRect = new Rectangle1(3, 10);
          ...
          double inches = Rectangle1.feetToInches(6.5); // calling the feetToInches STATIC method
          System.out.println(inches);
          System.out.println(myRect.perimeter());
          System.out.println(Rectangle1.inchesToFeet(100));
